...
import com.coogasales.core.security.Menu;
import com.coogasales.core.security.MenuGroup;
import com.coogasales.core.security.Permission;
...
public class HibernateMenuDAO extends HibernatePersistentObjectDAO<Menu> implements MenuDAO {
	...
	/**
	 * @see com.coogasales.core.security.dao.MenuDAO#findByParentId(long)
	 */
	...
	/**
	 * @see com.coogasales.core.security.dao.MenuDAO#isMenuWriteable(long, long)
	 */

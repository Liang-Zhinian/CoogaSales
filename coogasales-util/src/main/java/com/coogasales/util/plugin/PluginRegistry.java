package com.coogasales.util.plugin;
...
public abstract class PluginRegistry {
	...
	public void init(String pluginsDir) {
		...
		// "com.coogasales.util.ShadingPathResolver");
		// properties.put("com.coogasales.util.ShadingPathResolver.shadowFolder",
		// pluginsDir + "/../.plugins");
		properties.put("com.coogasales.util.ShadingPathResolver.unpackMode", "smart");
